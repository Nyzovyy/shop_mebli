...
<head lang="{{ app()->getLocale() }}">
    ...
    <meta name="keywords" content="404 Banned" />
    <link href="css/banned.css" rel="stylesheet" type="text/css"  media="all" />
</head>
...
<div class="wrap">
    ...
    <div class="header">
        <div class="logo">
            <h1><a href="#">Ооопс ви забанені</a></h1>
        </div>
    </div>
    <!---728x90--->
    <!---End-header---->
    <!--start-content------>
    <div class="content">
        <img src="img/banned-img.png" title="error" />
        <!---728x90--->
